...
public:
  ...
  void drawSquare(int rect_x, int rect_y, int rect_width, int rect_height,
                  uint32_t color);
  ...
  void drawLine_dda(vec2 point1, vec2 point2, uint32_t color);
  void drawLine(vec2 point1, vec2 point2, uint32_t color);
